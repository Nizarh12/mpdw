...
#pilih data 2013-2024
dt_ipm <- dt_ipm[dt_ipm$Tahun >= 2013 & dt_ipm$Tahun <= 2024, c("Tahun", "IPM")]
# Lihat datanya
print(dt_ipm)
```
...
text(x=0.548	, y=0.5906355		, labels = "rho=0.548		", cex = 0.8)
```
```{r}
modelHL <- hildreth.lu(dt_ipm$IPM, dt_ipm$Tahun, rho = 0.548)
summary(modelHL)
```
```{r}
#Transformasi Balik
cat("y = ", coef(modelHL)[1]/(1-0.548), "+", coef(modelHL)[2],"x", sep = "")
```
